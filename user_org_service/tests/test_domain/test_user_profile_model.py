...
class TestUserProfileModel:
    def test_create_user_profile(self):
        profile = UserProfile.objects.create(
            user_id="123e4567-e89b-12d3-a456-426614174000", email="test@example.com", first_name="John", last_name="Doe"
        )
    ...
    def test_update_profile_info(self):
        ...
        profile.update_info(first_name="Jane", last_name="Smith", bio="Software Developer")
