"""
Django settings for superadmin_service project.
...
ROOT_URLCONF = "superadmin_service.urls"
...
WSGI_APPLICATION = "superadmin_service.wsgi.application"
...
USER_ORG_SERVICE_URL = config("USER_ORG_SERVICE_URL", default="http://localhost:8002")
