...
class CreateSessionService:
    ...
    def execute(self, user, ip_address=None, user_agent=None):
        ...
        session = Session.objects.create(
            user=user, ip_address=ip_address, user_agent=user_agent, device_type=device_type, browser=browser, os=os
        )
        ...
        self.audit_service.log_event(
            ...
            metadata={"session_id": str(session.id), "device_type": device_type, "browser": browser, "os": os},
        )
