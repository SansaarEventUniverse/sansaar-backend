...
class LoginService:
    ...
    def execute(self, email, password, mfa_code=None, ip_address=None, user_agent=None):
        ...
        if not user.check_password(password):
            ...
            LoginAttempt.objects.create(user=user, ip_address=ip_address, success=False)
        ...
        # Create session
        session = self.session_service.execute(user=user, ip_address=ip_address, user_agent=user_agent)
