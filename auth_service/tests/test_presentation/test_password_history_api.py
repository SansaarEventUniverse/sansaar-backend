...
class TestPasswordHistoryAPI:
    ...
    def test_change_password_rejects_recent_password(self):
        ...
        response = self.client.post(
            "/api/auth/password-change/", {"current_password": "NewPassword@456", "new_password": "Password@123"}
        )
    ...
    def test_reset_password_rejects_recent_password(self):
        ...
        response = self.client.post(
            "/api/auth/password-reset/confirm/", {"token": token.token, "new_password": "Password@123"}
        )
