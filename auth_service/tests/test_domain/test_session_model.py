...
class TestSessionModel:
    ...
    def test_user_can_have_multiple_sessions(self):
        Session.objects.create(user=self.user, ip_address="192.168.1.1", user_agent="Mozilla/5.0")
        Session.objects.create(user=self.user, ip_address="192.168.1.2", user_agent="Safari")
