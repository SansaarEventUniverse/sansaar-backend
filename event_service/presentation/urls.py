...
from presentation.views.collaboration_views import (
    create_collaboration,
    get_collaboration_tasks,
    get_team_coordination,
)
...
urlpatterns = [
    ...
    # Collaboration
    path('<str:event_id>/collaboration/', create_collaboration, name='create_collaboration'),
    path('collaborations/<int:collaboration_id>/tasks/', get_collaboration_tasks, name='get_collaboration_tasks'),
    path('collaborations/<int:collaboration_id>/team/', get_team_coordination, name='get_team_coordination'),
